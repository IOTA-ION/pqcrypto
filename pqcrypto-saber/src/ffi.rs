...
extern "C" {
    ...
    pub fn PQCLEAN_FIRESABER_CLEAN_crypto_kem_keypair_seed(
        seed: *const u8,
        pk: *mut u8,
        sk: *mut u8,
    ) -> c_int;
...
extern "C" {
    ...
    pub fn PQCLEAN_LIGHTSABER_CLEAN_crypto_kem_keypair_seed(
        seed: *const u8,
        pk: *mut u8,
        sk: *mut u8,
    ) -> c_int;
...
extern "C" {
    ...
    pub fn PQCLEAN_SABER_CLEAN_crypto_kem_keypair_seed(
        seed: *const u8,
        pk: *mut u8,
        sk: *mut u8,
    ) -> c_int;
